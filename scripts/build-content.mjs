...
const openings = [
  {
    ...
    quote: { text: "Ayuda a tus piezas para que ellas puedan ayudarte.", author: "Paul Morphy", years: "1837–1884", nationality: "estadounidense" },
    sourceDir: "italiana",
  ...
  },
  {
    ...
    quote: { text: "No creo en la psicología. Creo en las buenas jugadas.", author: "Bobby Fischer", years: "1943–2008", nationality: "estadounidense" },
    sourceDir: "espanola",
  ...
  },
  {
    ...
    quote: { text: "El ajedrez es la vida en miniatura. El ajedrez es lucha, el ajedrez es batalla.", author: "Garry Kasparov", years: "1963–", nationality: "ruso" },
    sourceDir: "escocesa",
