...
renderBoard(document.getElementById("heroBoard"), parseFen("r1bqkbnr/pppp1ppp/2n5/1B2p3/4P3/5N2/PPPP1PPP/RNBQK2R b KQkq - 3 3"));
renderLesson();
renderPractice();
renderVariant();
renderComparison();
